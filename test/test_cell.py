...
class TestCell(unittest.TestCase):
    @ddt.idata([
        ...
        ('A1', '=HLOOKUP(-1.1,{-1.1,2.1,3.1,4.1;5,6,7,8},"2.9",0)', {},
         '<Ranges>(A1)=[[5]]'),
        ('A1', '=_XLFN.XLOOKUP(-1.1,{-1.1,2.1,3.1,4.1},{5,6,7,8},"Not found")', {},
         '<Ranges>(A1)=[[5]]'),
        ('A1', '=_XLFN.XLOOKUP(-1.1,{-1.1,2.1,3.1,4.1},{5,6,7,8})', {},
         '<Ranges>(A1)=[[5]]'),
        ('A1', '=_XLFN.XLOOKUP(777,{-1.1,2.1,3.1,4.1},{5,6,7,8},2)', {},
         '<Ranges>(A1)=[[2]]'),
        ('A1', '=_XLFN.XLOOKUP(2.1,{-1.1,2.1,3.1,2.1},{5,6,7,8},2)', {},
         '<Ranges>(A1)=[[6]]'),
        ('A1', '=_XLFN.XLOOKUP(889,{888,888,3.1,888},{5,6,7,8},333,-1)', {},
         '<Ranges>(A1)=[[333]]'),
        ('A1', '=_XLFN.XLOOKUP(889,{888,888,3.1,888},{5,6,7,8},,0)', {},
         '<Ranges>(A1)=[[#N/A]]'),
